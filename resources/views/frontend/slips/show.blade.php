		...
		<div class="col s11 m6 l4 offset-1">
				...
				{!! Form::open(array('url' => '/changehousestatus', 'method'=>'POST')) !!}
					...
					@foreach($street['house'] as $key => $house)
						@if($key <> "id")
						<div class="ident-1">
							{!! Form::checkbox('completed', true, $house['status'], array('data-id' => $key, 'data-map' => $myMap['id'], 'data-assignment' => $ass_id, 'class' => 'houseStatus filled-in', 'id' => 'house'.$house['number'])) !!}
